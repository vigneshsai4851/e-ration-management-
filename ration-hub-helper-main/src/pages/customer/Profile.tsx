...
import { User, CalendarDays, MapPin, Phone, IdCard } from 'lucide-react';
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium leading-none">Smart Card Number</p>
                  <p className="text-sm text-muted-foreground">
                    {currentUser?.smartCardNumber || 'Not Available'}
                  </p>
                </div>
              </div>
